...
- 🟢 **Input Tokens** — all prompt/context tokens sent to models
- 🔵 **Output Tokens** — all completion tokens generated by models
- 🟣 **Total Tokens** — input + output + cache (lifetime cumulative, never resets)

**Lifetime Total:** 1,527,043,420 tokens (from 1,336 sessions)
